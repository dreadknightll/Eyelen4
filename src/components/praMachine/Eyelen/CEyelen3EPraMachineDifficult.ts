 ...
 *
 */
class CEyelen3EPraMachineDifficult implements IPlainLenPraMachine {
//    public m_pm; // 旧版练习机器模型。本类是在依赖旧版的基础上进行扩充实现的。
    ...
    public m_lenChecker: ILenCheckerDifficult; // 长度比较器。比较用户输入的长度和正确的长度，返回准确度评定结果。
    ...
    public getLenChecker():ILenCheckerWithCa {
